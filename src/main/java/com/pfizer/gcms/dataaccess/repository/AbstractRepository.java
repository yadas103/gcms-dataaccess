...
public abstract class AbstractRepository<ModelType extends BaseModel> implements IRepository<ModelType>{
	...
	public List<BusinessProfileDisplayDTO> findByCountry(String name,String type,String lastName, String city,String firstName,String address,String speciality,String uniqueTypeCode, String uniqueTypeId)
			throws Exception {
		return null;
	}
